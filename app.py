...
# Manual CORS headers (proven to work)
@app.after_request
...
# Other models (EmployeeDocument, Job, Product, Stock, Invoice, InvoiceItem, Payment, LogbookReport) as in previous full version

# Seeding (admin, branches, employees, products/stock)

# Routes
@app.route('/')
def home():
    return "AZEX PestGuard Backend is LIVE! Full features restored"
...
# All other routes (branches, employees CRUD + photo, technicians filter, customers, jobs, products, stock, invoices CRUD + email, etc.) as in previous full versions

# Employee photo upload and serve (as previous)
